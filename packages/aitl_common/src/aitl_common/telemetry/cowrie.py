...
re-validating it with this same parser;
...
class Accepted:
    ...
    # The validated JSON object, read-only. Every value is untrusted attacker-
    # influenced data; structural fields were validated above.
